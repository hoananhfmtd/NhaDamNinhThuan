...
const ChiTieuSoLuongDoiTuongNuocMuaLVS = () => {
        ...
        <>
            ...
            <MyTable2
                ...
                columns={[
                    ...
                    {
                        headerName: 'Số lượng đối tượng ', field: 'soLuongDoiTuongNuocMua', width: 'auto', flex: 1, suppressSizeToFit: true,
                        cellRenderer: (params) => {
                            if (params.data.soLuongDoiTuongNuocMua > 0 && CanListDetailOfReport(user, "lvs", params.data.luuVucSongId)) {
...
export { ChiTieuSoLuongDoiTuongNuocMuaLVS }
